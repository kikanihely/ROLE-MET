...
const AUTH_TOKEN =
  "Bearer AstraCS:tBmdlBzZTpdYvrhzeeLFiyyT:8ed2309392d0dbe2aa607a134528df24d356956a4cae1d92d95b7256f2a4b3f2";
...
const langFlowGetScore = async (data) => {
  try {
      ...
      body:JSON.stringify({
        ...
        tweaks: {
          ...
          "Prompt-ZGVpn": {
                  ...
                  "output": "json\n{\n  \"resume_match_score\": 78,\n  \"analysis\": {\n    \"skills_match\": \"Good match (Candidate has 80% of required skills, missing AWS expertise)\",\n    \"experience_relevance\": \"Relevant experience in mobile development, lacks full-stack exposure\",\n    \"education_fit\": \"Meets education criteria (BE Computer Engineering)\",\n    \"certifications_projects\": \"Good projects, but lacks industry-recognized certifications\",\n    \"overall_strengths\": [\"Strong programming skills\", \"Experience in Android development\"],\n    \"overall_weaknesses\": [\"Limited exposure to cloud technologies\", \"No leadership experience\"]\n  }\n}"
          },
          "ChatOutput-8jm0K": {
                  "background_color": "",
                  "chat_icon": "",
    ...
    if (result.outputs && result.outputs.length > 0) {
      console.log("data response : ", result.outputs[0].outputs[0].artifacts.message);
    } else {
